...
public class CircularSeekBar extends View {
	...
	private static final int DEFAULT_POINTER_BORDER_COLOR = Color.argb(235, 74, 138, 255);
	...
	private int mPointerColor = DEFAULT_POINTER_COLOR;
	 ...
	 /**
     * Holds the color value for {@code mPointerBorderPaint} before the {@code Paint} instance is created.
     */
    private int mPointerBorderColor = DEFAULT_POINTER_BORDER_COLOR;
	...
	private void initAttributes(TypedArray attrArray) {
		...
		mMax = attrArray.getFloat(R.styleable.CircularSeekBar_max, DEFAULT_MAX);
		mProgress = attrArray.getFloat(R.styleable.CircularSeekBar_progress, DEFAULT_PROGRESS);
	...
	public float getProgress() {
		float progress = /*Math.round*/(mMax * mProgressDegrees / mTotalCircleDegrees);
		return progress;
	}
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		mCircleHeight = height / 2f - mCircleStrokeWidth - mPointerRadius - (mPointerHaloBorderWidth * 1.5f);
		mCircleWidth = width / 2f - mCircleStrokeWidth - mPointerRadius - (mPointerHaloBorderWidth * 1.5f);
	...
	/**
     * Sets the pointer border color.
     * @param color the color of the pointer
     */
	public void setPointerBorderColor(int color) {
	    mPointerBorderColor = color;
	    mPointerHaloBorderPaint.setColor(mPointerBorderColor);
	    invalidate();
	}

	 /**
     * Gets the pointer border color.
     * @return An integer color value for the pointer
     */
	public int getPointerBorderColor() {
	    return mPointerBorderColor;
	}
