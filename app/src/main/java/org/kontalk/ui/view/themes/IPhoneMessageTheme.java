...
/**
 * Theme based on (a somewhat old) iPhone.
 * @author Daniele Ricci
 */
public class IPhoneMessageTheme extends SimpleMessageTheme {

    private IPhoneMessageTheme(int direction, boolean groupChat) {
         super(R.drawable.balloon_iphone_incoming,
    ...
    public static final class FactoryCreator implements MessageListItemThemeFactory.FactoryCreator {
        ...
        public MessageListItemTheme create(int direction, boolean groupChat) {
            return new IPhoneMessageTheme(direction, groupChat);
        }
