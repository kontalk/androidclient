...
/**
 * Presence available event.
 * @author Daniele Ricci
 */
public class UserOnlineEvent extends PresenceEvent {

    public UserOnlineEvent(Jid jid, Presence.Mode mode, int priority,
            String status, Date delay, String rosterName,
            boolean subscribedFrom, boolean subscribedTo,
            String fingerprint, String id) {
        super(jid, Presence.Type.available, mode, priority,
